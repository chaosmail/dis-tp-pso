...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Results}
The best weights in Webots were obtained running a noisy PSO on a random leader trajectory with random acceleration (180 iterations). These weights are $-24.45, 4.96, 1.69, -0.43, 5.70, 100.01, 56.63, -71.26$ and $17.65$, where the first 6 correspond to the proximity sensors, 7 to the BIAS and 8 and 9 to the recursive connections. Applying these weights to the epuck immediately gave a good chain following behaviour.
